...
export class BankComponent {
  ...
  updateBank(form: any): Promise<any> {
    ...
    this.bank = {
      $class: "org.decentralized.resource.network.Bank",          
            "name":this.name.value,                      

             "coins": "resource:org.decentralized.resource.network.Coins#CO_" + form.get("bankID").value,
             "cash": "resource:org.decentralized.resource.network.Cash#CA_" + form.get("bankID").value,
    };
